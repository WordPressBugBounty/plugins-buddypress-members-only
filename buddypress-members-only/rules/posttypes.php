...
function bpMembersOnlyFreePostTypesSettings()
{
    ...
    $passed_default_post_types = array(
    ...
    <div style='margin:10px 5px;'>
        <div style='float:left;margin-right:10px;'>
             <img src='<?php echo esc_url(plugins_url('../images/new.png', __FILE__)); //!!! 3.6.3?>'
        ...
        <div style='padding-top:5px; font-size:22px;'>
			<?php
                /*
                //before 3.6.3
                <i>BuddyPress Members Only Restrict Custom Post Types Settings:</i>
                */
                //!!! 3.6.3
    ?>
			...
			<i>
			<?php
        esc_html__('BuddyPress Members Only Restrict Custom Post Types Settings:', 'bp-members-only');
    ?>
			</i>
        </div>
    </div>
...
function buddypress_members_free_post_type_setting_panel($bp_component_role)
{
                ...
                <div id="post-body">
                    <div id="dashboard-widgets-main-content">
                        <div class="postbox-container" style="width: 90%;">
                            <div class="postbox bp-members-pro-componet-each-role-bar close-bar"
                                ...
                                <h3 class='hndle'
                                    ...
                                    if ('default' === $bp_component_role_id) {
                                        ...
                                        //!!! 3.6.3
                                        echo esc_html__('Restricts these Post Types to -- ', 'bp-members-only') .
                                             '<strong>' . esc_html__('Non Members / Guest Users', 'bp-members-only') . '</strong>';
                                    }
    ?>
                                </h3>
                                    ...
                                    <table id="bpmotable" width="100%">
                                        <tr>
                                            <td width="30%" style="padding: 30px 20px 20px 20px;" valign="top">
                                                <?php esc_html_e('Opened Post Types:', 'bp-members-only'); //!!! 3.6.3?>
                                            </td>
                                            <td width="70%" style="padding: 20px;">
                                                <p>
                                                    <?php esc_html_e('Open these post types to guest:', 'bp-members-only'); //!!! 3.6.3?>
                                                </p>
                                                <hr/>
                                        ...
                                        if ((isset($all_post_types)) && (is_array($all_post_types)) && (count($all_post_types) > 0)) {
                                            ...
                                            foreach ($all_post_types as $single_post_types) {
												...
												<?php //3.2.3?>
												<input type="checkbox" <?php echo esc_attr($is_enabled_post_type_statu); ?>  name="bpmemonlypro_enabled_post_type_<?php echo esc_attr($tomas_roles_single_name); ?>[]"  value="<?php echo esc_attr($single_post_types); ?>"><?php echo esc_html($single_post_types); //!!! 3.6.3?>
												<?php
                                                /*
    ...
    ?>
                                                ...
                                                <p>
                                                    <font color="Gray">
                                                        <i>
                                                            <?php
            esc_html_e('Checked post types will opened to ', 'bp-members-only'); //!!! 3.6.3
			if ($tomas_roles_single_name == 'default') {
				$tomas_roles_single_name = 'guest';
			}
			echo esc_html($tomas_roles_single_name);
    ...
    ?>
                                    <input type="submit"
                                           id="bpmemonlypro_enabled_post_type_submit"
                                           name="<?php echo esc_attr($rolebasedstandardcomponentsubmit); ?>"
                                           value=" Submit "
